...
-- if the image isn't big enough or too big then do scaleObject('(obj)', (size)') big chungus deez nuts 
-- if you wanna make put the sprites in a different folder change the path on line 25/26

-- //CONFIG//
local composer = 'Boil And Buster' -- change composer name here
local composerIcon = 'composerIcon' -- change composer icon here
